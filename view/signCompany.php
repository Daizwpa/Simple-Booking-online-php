        ...
        <div class="container styleline ">
            <div class="row py-5 mt-4 align-items-center">
                ...
                <div class="col-md-7 col-lg-6 ml-auto lgi bg-light pt-5 rounded">
                    <form action="./../controller/registerAsCompanyController.php" enctype="multipart/form-data" method="post">
                        <div class="row">
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <input id="firstName" type="text" name="name" placeholder="Company Name" class="form-control bg-white border-left-0 border-md">
                            </div>
                            ...
                            <div class="input-group col-lg-12 mb-4">
                                ...
                                <textarea  id="phoneNumber" class="form-control custom-select bg-white border-left-0 border-md"  name="about" placeholder="about" ></textarea >
                            </div>
