      ...
      <div class="page-content d-flex align-items-stretch"> 
        ...
        <nav class="side-navbar">
          ...
          <ul class="list-unstyled">
            ...
            <li class="active"><a href="./search.php"><i class="icon-search"> Search</i></a></li>
                    ...
                    <div class="card-body">
                       <div class="col-lg-12">
                            ...
                            <label class="form-label" for="form1">Search</label>
                              <input type="search" onchange="search()" id="searchBox" class="form-control col-lg-12" />
                              
                            </div>
                            <div class="line"></div>
                            <label class="form-label" for="form1">Results</label>
